...
func main() {
	rootCmd.AddCommand(runCmd, approveCmd, rejectCmd, statusCmd, planStatusCmd, statsCmd, indexCmd, listCmd, sessionsCmd, sessionCmd, serveCmd, initGlobalCmd, initCmd, planCmd, ragDumpCmd, versionCmd)
